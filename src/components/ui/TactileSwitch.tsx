        ...
        <div className="bg-black border-2 border-border-heavy p-4 tactile-switch">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="w-12 h-6 bg-zinc-900 border-2 border-black relative cursor-pointer shadow-[inset_0px_2px_4px_black] overflow-hidden">
                    <div className={`absolute top-0 ${isActive ? 'right-0 w-full' : 'right-0 w-0'} h-full ${indicatorColor} ${neonClass} transition-all duration-200 opacity-20`}></div>
                    <div className={`absolute top-0 ${isActive ? 'left-0 border-r-2' : 'right-0 border-l-2'} w-6 h-full bg-zinc-700 border-black flex items-center justify-center transition-all duration-200 z-10`}>
